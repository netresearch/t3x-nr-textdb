...
**Test configuration:**
- Unit config: `Build/UnitTests.xml` (PHPUnit 13)
...
- Official docs: https://docs.phpunit.de/ (this project uses PHPUnit 13, see the schema in `Build/UnitTests.xml`)

**Project-specific:**
- Check existing test patterns in `Tests/Unit/` and `Tests/Functional/`
- Review `Build/UnitTests.xml` and `Build/FunctionalTests.xml` for configuration
