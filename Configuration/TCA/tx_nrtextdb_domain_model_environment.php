...
return [
    'ctrl' => [
        ...
        'searchFields' => 'name',
        'iconfile' => 'EXT:nr_textdb/Resources/Public/Icons/tx_nrtextdb_domain_model_environment.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_nrtextdb_domain_model_environment}.{#pid}=###CURRENT_PID### AND {#tx_nrtextdb_domain_model_environment}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
