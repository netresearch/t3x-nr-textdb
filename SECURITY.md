...
Use [GitHub Security Advisories](https://github.com/netresearch/t3x-nr-textdb/security/advisories/new) to report vulnerabilities privately.
...
This policy covers the `nr_textdb` TYPO3 extension code. For vulnerabilities in dependencies or TYPO3 core, please report to the respective upstream projects.
